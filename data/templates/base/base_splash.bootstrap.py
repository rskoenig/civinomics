...
_magic_number = 7
_modified_time = 1398463802.840589
_template_filename = u'/home/maria/civinomics/pylowiki/templates/base/base_splash.bootstrap'
_template_uri = u'/base/base_splash.bootstrap'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\n\n<div id="wrap">\n   ')
        # SOURCE LINE 5
        __M_writer(escape(helpers.splashNavbar()))
        __M_writer(u'\n   <div>\n      ')
        # SOURCE LINE 7

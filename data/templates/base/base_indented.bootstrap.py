...
_magic_number = 7
_modified_time = 1398463804.8635359
_template_filename = u'/home/maria/civinomics/pylowiki/templates/base/base_indented.bootstrap'
_template_uri = u'/base/base_indented.bootstrap'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\n   </div>\n</div><!-- close wrap -->\n')
        # SOURCE LINE 10
        __M_writer(escape(helpers.shortFooter()))
        __M_writer(u'\n')
        # SOURCE LINE 11
        if c.authuser and c.privs:
            ...
            if c.privs['provisional']:
                # SOURCE LINE 13
                __M_writer(u'\t\t')
                __M_writer(escape(helpers.activateAccountModal()))
                __M_writer(u'\n')
                pass
            pass
        # SOURCE LINE 16

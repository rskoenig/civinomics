...
"""
    These are functions for manually implementing oauth with twitter.
    These don't work correctly yet, but they're close. These are not needed, but
    will help give a head start should we need to implement a manual oauth setup at
    some point.
"""

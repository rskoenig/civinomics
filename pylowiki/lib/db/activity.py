...
def getRecentActivity(limit, comments = 0, offset = 0):
        ...
        q = meta.Session.query(Thing)\
            ...
            .filter(Thing.data.any(or_(or_(and_(Data.key.ilike('%public'), Data.value == u'1'), and_(Data.key == 'workshop_searchable', Data.value == u'1')), and_(Data.key == 'format', Data.value == 'png'), and_(Data.key == 'public', Data.value == u'1'))))\
            .order_by('-date')\
            .offset(offset)
        if limit:

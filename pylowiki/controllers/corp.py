...
class CorpController(BaseController):
    ...
    def caseStudies(self):
        ...
        c.studies=[]
        banAnniversary={}
        banAnniversary["title"]="Santa Cruz County Bag Ban at One Year"
        banAnniversary["description"]="What do you think about the fee increase to $0.25 on paper bags?"
        banAnniversary["image"]="ban_cover.jpg"
        banAnniversary["url"]="banAnniversary"
        banAnniversary['date']="3.22.13"
        c.studies.append(banAnniversary)
        bizFair13={}
        bizFair13["title"]="Santa Cruz County Business Fair 2013"
        bizFair13["description"]="What issues do local business owners care most about?"
        bizFair13["image"]="BizFair_cover.jpg"
        bizFair13["url"]="bizFair13"
        bizFair13['date']="3.14.13"
        c.studies.append(bizFair13)
        SSIP={}

...
def jsonizeComment(comment, myRatings):
    entry = {}
    ...
    entry['revisionList'] = []
    if revisions:
        entry['revisionList'] = [jsonizeRevisions(rev) for rev in revisions]            
    return entry
...
class CommentController(BaseController):
    ...
    def jsonCommentsForItem(self, urlCode):
        ...
        result = [jsonizeComment(comment, myRatings) for comment in comments]

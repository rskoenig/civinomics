    ...
    $(document).ready(function() {
        guiders.createGuider({
            buttons: [{name: "next"}],
            description: "This is the conversations listing page where we talk. Participants can start conversations related to the workshop topic to ask questions, provide feedback to the facilitator and listeners, or generally discuss topics related to the workshop.",
            id: "tour_0",
            next: "tour_1",

    ...
    $(document).ready(function() {
        guiders.createGuider({
            buttons: [{name: "next"}],
            description: "This is the information resources listing page. Participants can add links to information resources on the Web which will help educate about the workshop topic.",
            id: "tour_0",
            next: "tour_1",

...
<div id ="footer_wrapper">
  <div id="footer_container" class="container_12">
      <div id="footer_block" class="grid_4">
          ...
          <a href="/corp?page=careers"> Careers </a>
          <a href="/corp?page=blog"> Blog </a>
          </div>
          <div id  = "footer_block_content" class="grid_1">
          <a href="/corp?page=features"> Features </a>
          <a href="/corp?page=services"> Services </a>
          </div>
          <div id  = "footer_block_content" style="padding-left:10px;" class="grid_2">
          <a href="/corp?page=terms" style="width:80%; margin-left:10px";> Terms of Use </a>
          <a href="/corp?page=privacy" style="width:80%; margin-left:10px";> Privacy Policy</a>
          </div>
      </div>
      <div id="footer_block" class="grid_2">
          ...
          <div id  = "footer_block_content" class="grid_1">
          <a href="/corp?page=about"> Facebook </a>
          <a href="/corp?page=about"> Twitter </a>
          </div>
     </div>
     <div id="footer_block" class="grid_2">
         <div id = "footer_block_header">
         ...
         <div id  = "footer_block_content" class="grid_1">
         <a href="/corp?page=about"> info@greenocracy.org </a>
         </div>
     </div>
  </div>
</div>

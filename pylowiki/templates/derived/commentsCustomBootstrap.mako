...
<%def name="comments( type )">
    ...
    %if c.conf['allow.comments'] == 'true':
        ...
        % if type == 'resource' and "user" in session:
            <div class="row-fluid">
                <span class="gray">
                    <a href="#" style="color:#86945A;">
                        ${discussion['numComments']}
                        ${commentString}
                    </a>
                    | Last edited 
                    <span class="time">
                        ${timeSince(c.lastmoddate)}
                    </span> 
                    ago by 
                    <a style="color:#86945A;" href = "/profile/${c.lastmoduser['urlCode']}/${c.lastmoduser['url']}">
                        ${c.lastmoduser['name']}
                    </a>
                    ${uTitle} 
                    <a href="#" class="gray flag">
                        Flag resource
                    </a>
            % if checkFlagged(c.resource):
                % if c.isAdmin == True or c.isFacilitator == True:
                    | 
                    <a href="/workshop/${c.w['urlCode']}/${c.w['url']}/resource/${c.resource['urlCode']}/${c.resource['url']}/modResource/">
                        Flagged
                    </a>
                % endif
            % endif
        ...
        % elif type == 'resource':
            <div class="row-fluid">
                <span class="gray">
                    <a href="#" style="color:#86945A;">
                        ${discussion['numComments']} ${commentString}
                    </a> 
                    | Last edited 
                    <span class="time">
                        ${timeSince(c.lastmoddate)}
        ...
        % elif type == 'suggestionMain' and "user" in session:
            <div class="row-fluid">
                <span class="gray">
                    ...
                    ago by 
                    <a href = "/profile/${c.lastmoduser['urlCode']}/${c.lastmoduser['url']}">
                        ${c.lastmoduser['name']}
                    </a>
                    ${uTitle} 
                    <a href="#" class="gray flag">
        ...
        % if c.events:
            ...
            <div id="comments" class="row-fluid">
                ...
                % for event in c.events:
                    ...
                    ${event['title']} ${event.date} by ${user['name']}
                    <br />
                    Note: ${event['data']}
                    <br /><br />
                % endfor
        ...
        <div id="comments" class="row-fluid">
            ...
            <form id="add_comment" action = "${c.site_secure_url}/addComment" class="form-vertical" method = "post">
                        ...
                        <fieldset>
                            <div class="control-group">
                                ...
                                <div class="controls docs-input-sizes">
                                    <textarea rows="4" id="comment-textarea" name="comment-textarea" onkeyup="previewAjax( 'comment-textarea', 'comment-preview-div' )" class="markitup" style="width:500px;">
                                    </textarea>
                                </div>
                            </div>
                            <div class="control-group">

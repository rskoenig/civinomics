...
<%def name="admin_items(itemlist, type, action, title)">
    % if itemlist:
        <table class="table table-bordered">
        <thead>
        <tr><th>${title}</th</tr>
...
<%def name="admin_flagged()">
    <div class="section-wrapper">
        <div class="browse">
            ...
            <br /><br />
            ${admin_items(c.r, 'resource', 'flagged', 'Flagged Resources and Comments')}
            <br /><br />
            ${admin_items(c.i, 'idea', 'flagged', 'Flagged Ideas and Comments')}
            <br /><br />
            ${admin_items(c.d, 'discussion', 'flagged', 'Flagged Discussions and Comments')}
        </div><!-- browse -->
    </div><!-- section-wrapper -->
</%def>
...
<%def name="admin_disabled()">
    <div class="section-wrapper">
        <div class="browse">
            ...
            <br /><br />
            ${admin_items(c.r, 'resource', 'disabled', 'Disabled Resources and Comments')}
            <br /><br />
            ${admin_items(c.i, 'idea', 'disabled', 'Disabled Ideas and Comments')}
            <br /><br />
            ${admin_items(c.d, 'discussion', 'disabled', 'Disabled Discussions and Comments')}
        </div><!-- browse -->
    </div><!-- section-wrapper -->
</%def>
...
<%def name="admin_deleted()">
    <div class="section-wrapper">
        <div class="browse">
            ...
            <br /><br />
            ${admin_items(c.r, 'resource', 'deleted', 'Deleted Resources and Comments')}
            <br /><br />
            ${admin_items(c.i, 'idea', 'deleted', 'Deletede Ideas and Comments')}
            <br /><br />
            ${admin_items(c.d, 'discussion', 'deleted', 'Deleted Discussions and Comments')}
        </div><!-- browse -->
    </div><!-- section-wrapper -->
</%def>

		...
		<div class="row">
    		...
    		%if not sidebar:
    		    <td><ul class="list-inline" style="">
        				<li style="margin-right:5px;"><span class="criteria-name">{{criteria.criteria}}</span>
        				<span data-toggle="tooltip" data-placement="top" data-original-title="{{descriptions[criteria.criteria]}}" class="glyphicon glyphicon-question-sign"></span></li>
                    </ul>
                </td>
                <td>
    		%elif sidebar:

                    ...
                    <div class="span9">
                        ...
                        <small>
                            % if c.searchType and c.searchType != 'region':
                                <a class="no-highlight" href="{{initiative.geoHref}}"><img class="thumbnail flag small-flag border" src="{{initiative.flag}}"> {{initiative.scopeLevel}} of {{initiative.scopeName}}</a><br>
                            % endif

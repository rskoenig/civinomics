...
def make_map():
    ...
    # Workshop "guests"
    map.connect('/guest/{id1}/{id2}', controller = 'workshop', action = 'guest', id1 = '{id1}', id2 = '{id2}')
    map.connect('/guest/{id1}/{id2}/', controller = 'workshop', action = 'guest', id1 = '{id1}', id2 = '{id2}')
    ...
    map.connect('/workshop/{id1}/{id2}/add/discussion', controller = 'discussion', action = 'addDiscussion', id1 = '{id1}', id2 = '{id2}')
    map.connect('/workshop/{id1}/{id2}/add/discussion/', controller = 'discussion', action = 'addDiscussion', id1 = '{id1}', id2 = '{id2}')
    map.connect('/workshops/{id1}/{id2}/add/discussion', controller = 'discussion', action = 'addDiscussion', id1 = '{id1}', id2 = '{id2}')
    map.connect('/workshops/{id1}/{id2}/add/discussion/', controller = 'discussion', action = 'addDiscussion', id1 = '{id1}', id2 = '{id2}')
    # New discussion
    map.connect('/workshop/{id1}/{id2}/add/discussion/handler', controller = 'discussion', action = 'addDiscussionHandler', id1 = '{id1}', id2 = '{id2}')
    map.connect('/workshop/{id1}/{id2}/add/discussion/handler/', controller = 'discussion', action = 'addDiscussionHandler', id1 = '{id1}', id2 = '{id2}')
    ...
    map.connect('/workshop/{id1}/{id2}/configureScopeWorkshopHandler', controller = 'workshop', action = 'configureScopeWorkshopHandler', id1 = '{id1}', id2 = '{id2}')
    map.connect('/workshop/{id1}/{id2}/configureBasicWorkshopHandler/', controller = 'workshop', action = 'configureBasicWorkshopHandler', id1 = '{id1}', id2 = '{id2}')
    ...
    map.connect('/workshop/{id1}/{id2}/configureStartWorkshopHandler/', controller = 'workshop', action = 'configureStartWorkshopHandler', id1 = '{id1}', id2 = '{id2}')
    map.connect('/workshop/{id1}/{id2}/configureContinueHandler', controller = 'workshop', action = 'dashboard', id1 = '{id1}', id2 = '{id2}')
    ...
    # Resources
    map.connect('/workshop/{id1}/{id2}/add/resource', controller = 'resource', action = 'addResource', id1 = '{id1}', id2 = '{id2}')
    map.connect('/workshop/{id1}/{id2}/add/resource/', controller = 'resource', action = 'addResource', id1 = '{id1}', id2 = '{id2}')
    map.connect('/workshop/{id1}/{id2}/add/resource/handler', controller = 'resource', action = 'addResourceHandler', id1 = '{id1}', id2 = '{id2}')
    map.connect('/workshop/{id1}/{id2}/add/resource/handler/', controller = 'resource', action = 'addResourceHandler', id1 = '{id1}', id2 = '{id2}')
    ...
    map.connect('/workshop/{id1}/{id2}/resource/{id3}/{id4}/', controller = 'resource', action = 'index', id1 = '{id1}', id2 = '{id2}', id3 = '{id3}', id4 = '{id4}', id5 = '')
    map.connect('/workshop/{id1}/{id2}/resource/{id3}/{id4}/thread/{id5}', controller = 'resource', action = 'thread', id1 = '{id1}', id2 = '{id2}', id3 = '{id3}', id4 = '{id4}', id5 = '{id5}')
    ...
    # Ideas
    map.connect('/workshop/{workshopCode}/{workshopURL}/ideas', controller = 'idea', action = 'listing', workshopCode = '{workshopCode}', workshopURL = '{workshopURL}')
    map.connect('/workshop/{workshopCode}/{workshopURL}/add/idea', controller = 'idea', action = 'addIdea', workshopCode = '{workshopCode}', workshopURL = '{workshopURL}')
    map.connect('/workshop/{workshopCode}/{workshopURL}/add/idea/handler', controller = 'idea', action = 'addIdeaHandler', workshopCode = '{workshopCode}', workshopURL = '{workshopURL}')
    map.connect('/workshop/{workshopCode}/{workshopURL}/idea/{ideaCode}/{ideaURL}', controller = 'idea', action = 'showIdea', workshopCode = '{workshopCode}', workshopURL = '{workshopURL}', ideaCode = '{ideaCode}', ideaURL = '{ideaURL}')
    ...
    # Ratings
    map.connect('/rate/suggestion/{id1}/{id2}/{id3}', controller = 'rating', action = 'rateSuggestion', id1 = '{id1}', id2 = '{id2}', id3 = '{id3}')
    map.connect('/rateFacilitation/{id1}/{id2}/{id3}', controller = 'rating', action = 'rateFacilitation', id1 = '{id1}', id2 = '{id2}', id3 = '{id3}')
    map.connect('/rate/resource/{id1}/{id2}/{id3}', controller = 'rating', action = 'rateResource', id1 = '{id1}', id2 = '{id2}', id3 = '{id3}')
    map.connect('/rate/discussion/{id1}/{id2}/{id3}', controller = 'rating', action = 'rateDiscussion', id1 = '{id1}', id2 = '{id2}', id3 = '{id3}')
    ...
    # Profile dashboard
    map.connect('/profile/{id1}/{id2}/dashboard', controller = 'profile', action = 'dashboard', id1 = '{id1}', id2 = '{id2}')
    map.connect('/profile/{id1}/{id2}/dashboard/', controller = 'profile', action = 'dashboard', id1 = '{id1}', id2 = '{id2}')
    map.connect('/profile/{id1}/{id2}/editHandler', controller = 'profile', action = 'editHandler', id1 = '{id1}', id2 = '{id2}')
    map.connect('/profile/{id1}/{id2}/editHandler/', controller = 'profile', action = 'editHandler', id1 = '{id1}', id2 = '{id2}')
    map.connect('/profile/{id1}/{id2}/passwordHandler', controller = 'profile', action = 'passwordHandler', id1 = '{id1}', id2 = '{id2}')
    map.connect('/profile/{id1}/{id2}/passwordHandler/', controller = 'profile', action = 'passwordHandler', id1 = '{id1}', id2 = '{id2}')

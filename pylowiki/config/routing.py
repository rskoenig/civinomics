...
def make_map():
    ...
    map.connect('/{workshop:workshops?}/{workshopCode}/{workshopURL}/goals/add/{criteria}{end:/?}',controller='criteria', action='addToWorkshop', workshopCode = '{workshopCode}', workshopURL = '{workshopURL}', criteria = '{criteria}')

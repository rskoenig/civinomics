...
def make_map():
    ...
    map.connect('/initiative/{id1}/{id2}/getResources{end:/?}', controller = 'initiative', action = 'getInitiativeResources', id1 = '{id1}', id2 = '{id2}', id3 = None)
    ...
    map.connect('/initiative/{id1}/{id2}/getUpdates{end:/?}', controller = 'initiative', action = 'getInitiativeUpdates', id1 = '{id1}', id2 = '{id2}', id3 = None)

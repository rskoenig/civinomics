...
def make_map():
    ...
    map.connect('/{workshop:workshops?}/{workshopCode}/{workshopURL}/{listenerStats:listenerStats?/?}', controller = 'workshop', action = 'listenerStats', workshopCode = '{workshopCode}', workshopURL = '{workshopURL}')
    map.connect('/{workshop:workshops?}/{workshopCode}/{workshopURL}/{version}/{publicStats:publicStats?/?}', controller = 'workshop', action = 'publicStats', workshopCode = '{workshopCode}', workshopURL = '{workshopURL}', version='{version}')
